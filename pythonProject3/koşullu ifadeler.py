# 1- Kullanicıdan isim, yaş ve eğitim bilgilerini isteyip ehliyet alabilme
...
# 85-100 => 5
'''''''''
yazilil = float(input('1.yazılı: '))
yazili2 = float(input('2.yazılı: '))
sozlu = float(input('sözlü: '))
ortalama = (yazilil + yazili2 + sozlu)/3

if 0 <= ortalama < 25:   #böyle yazmak daha kolay aşağıdaki daha havalı
